...
(tooltip-mode -1)
(set-fringe-mode -1)
(set-frame-font "Iosevka Aile" nil t)
(setq visible-bell t)
...
(use-package org
  ...
  (setq org-capture-templates
    `(("t" "Tasks / Projects")
      ("tt" "Task" entry (file+olp "~/Projects/OrgVault/Tasks.org" "Inbox")
           "* TODO %?\n  %U\n  %a\n  %i" :empty-lines 1)

      ("j" "Journal Entries")
      ("jj" "Journal" entry
           (file+olp+datetree "~/Projects/OrgVault/Journal.org")
      ...
      ("w" "Workflows")
      ("we" "Checking Email" entry (file+olp+datetree "~/Projects/OrgVault/Journal.org")
           "* Checking Email :email:\n\n%?" :clock-in :clock-resume :empty-lines 1)

      ("m" "Metrics Capture")
      ("mw" "Weight" table-line (file+headline "~/Projects/OrgVault/Metrics.org" "Weight")
...
(use-package term
  ...
  ;;(setq explicit-zsh-args '())         ;; Use 'xplicit-<shell>-args for shell-specific args
